...
| Tool | Arguments | Notes |
|---|---|---|
| `get_system_config` | none | Returns added providers, the built-in `provider_catalog`, active selections and search settings. API keys are redacted to `has_api_key`. |
